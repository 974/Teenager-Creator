...
class TeenagersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create teenager" do
    assert_difference('Teenager.count') do
      post teenagers_url, params: { teenager: { name: @teenager.name, type: @teenager.type } }
    end
  ...
  test "should update teenager" do
    patch teenager_url(@teenager), params: { teenager: { name: @teenager.name, type: @teenager.type } }
